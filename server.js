...
app.get('/api/getSetlists/:artistName/:pageNum', function(req, res) {
  setlistfmClient.searchSetlists({
    artistName: req.params.artistName,
    p: req.params.pageNum
  })
...
app.get('/api/getSetlist/:setid', function(req, res) {
  setlistfmClient.getSetlist(req.params.setid)
    .then(function(results) {
      res.send(results);
    })
    .catch((error => {
